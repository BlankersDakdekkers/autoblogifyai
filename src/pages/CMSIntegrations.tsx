...
import ActiveCMSIntegrations from "@/components/ActiveCMSIntegrations";

const CMSIntegrations = () => {
  const [modalOpen, setModalOpen] = useState(false);
  const [selectedCMS, setSelectedCMS] = useState<'wordpress' | 'strapi' | 'drupal' | null>(null);
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 p-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-center">Beschikbare CMS Platformen</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-xl transition-all duration-300 border-blue-200 hover:border-blue-400 transform hover:-translate-y-1">
              ...
              <CardContent>
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-blue-200 hover:bg-blue-50 font-semibold"
                  onClick={() => handleConfigureCMS('wordpress')}
                >
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-purple-200 hover:border-purple-400 transform hover:-translate-y-1">
              ...
              <CardContent>
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-purple-200 hover:bg-purple-50 font-semibold"
                  onClick={() => handleConfigureCMS('strapi')}
                >
                  <Settings className="h-4 w-4 mr-2" />
                  Strapi Verbinden
                </Button>
            ...
            <Card className="hover:shadow-xl transition-all duration-300 border-orange-200 hover:border-orange-400 transform hover:-translate-y-1">
              ...
              <CardContent>
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-orange-200 hover:bg-orange-50 font-semibold"
                  onClick={() => handleConfigureCMS('drupal')}
                >
                  <Settings className="h-4 w-4 mr-2" />
                  Drupal Instellen
                </Button>
        ...
        <div className="bg-card rounded-lg p-6 border">
          <ActiveCMSIntegrations refreshTrigger={refreshTrigger} />
        </div>
