...
import CMSIntegrationsDashboard from "./pages/CMSIntegrationsDashboard";
        ...
        >
          <AuthProvider>
            <Routes>
              ...
              <Route path="/dashboard/cms-integrations" element={<ProtectedRoute><Layout><CMSIntegrationsDashboard /></Layout></ProtectedRoute>} />
