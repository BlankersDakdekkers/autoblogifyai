...
import CMSIntegrationsNew from "./pages/CMSIntegrationsNew";
        ...
        >
          <AuthProvider>
            <Routes>
              ...
              <Route path="/dashboard/cms-integrations" element={<ProtectedRoute><Layout><CMSIntegrationsNew /></Layout></ProtectedRoute>} />
