...
-- Update get_credit_limit_for_tier function with proper search_path
...
-- Update refresh_monthly_credits function with proper search_path
...
-- Update update_subscription_tier function with proper search_path
